...
---从符卡表中拿到一个符卡
---@param name string|number @类名或者索引
---@return table
...
---ex boss联合符卡事件循环
---！警告：该方法依赖task环境
---@param coopname string|number
---@param mode number
---@param waittime number @所有事件结束后等待事件
...
---清除boss的碎片掉落
---@param spell boolean @bomb碎片不掉落
---@param chip boolean @残机碎片不掉落

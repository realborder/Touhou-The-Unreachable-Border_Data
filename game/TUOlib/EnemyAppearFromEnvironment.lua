...
-----------------------------------
---参数表	参数名 类型 备注
---@param self table 写敌机
---@param duration number 非0，为正则从背景出现，为负责从背景消失，数字大小指代持续帧数
---@param r number 环境色，从背景出现时对象的颜色会逐渐从这个颜色过渡
---@param g number 环境色，从背景出现时对象的颜色会逐渐从这个颜色过渡
---@param b number 环境色，从背景出现时对象的颜色会逐渐从这个颜色过渡
---@param scale_min,scale_max number 从背景渐隐渐显时的最大scale和最小scale

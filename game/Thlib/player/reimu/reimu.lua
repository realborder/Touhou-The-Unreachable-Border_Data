...
function reimu_player:init(slot)
	...
	LoadImageFromFile('reimu_bomb_ef','THlib\\player\\reimu\\reimu_bomb_ef.png')
	-----------------------------------------
	local sf=0.5 --scale fix
	LoadImage('reimu_main_bullet','reimu_bullet',128,0,128,64,32*sf,32*sf)
	...
	LoadImage('reimu_side_bullet','reimu_bullet',384,0,64,64,32*sf,32*sf)
	...
	LoadImage('reimu_side_bullet2','reimu_bullet',128,64,128,64,64*sf,16*sf)

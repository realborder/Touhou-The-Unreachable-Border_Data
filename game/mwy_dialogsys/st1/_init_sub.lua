...
local _tmp_dialog={
	...
	[3]={
		...
		{REIMU,'ease3','什么嘛，原来只是妖怪鸟而已，能和妖精合作的妖怪果然也强不到哪里去啊。'},
	...
	[1+100]={
		{MARISA,'smile','你看到的是一个没完成的对话'},
		{MARISA,'smile','嗯……赶紧长按z跳过吧'},
		{MARISA,'smile','哎呀呀，又一个没有睡着的人类。'},
		{MARISA,'smile','就算到了这种时候，妖精还是一副无忧无虑的样子呢。'},
		{MARISA,'smile','这也应该计入神社人气底的原因'}
	},
	[2+100]={
		{MARISA,'smile','去人类村落的路还是一如既往地难走。'},
		{MARISA,'smile','而且没走多远就被烦人的家伙袭击了，真是糟糕的开端啊。'},
		{MARISA,'smile','这种时候？……是指因为人们的梦能够到达现实来吗？'},
		{MARISA,'smile','没想到妖精会清楚这种事情，你难道就没有由于异变的原因烧掉房子什么的吗？'},
		{MARISA,'smile','怎么会，明明这异变这么有意思！'},
		{MARISA,'smile','梦多么的美妙啊，人们的梦往往会带来惊喜呢。'},
		{MARISA,'smile','呵，除了‘惊喜’，更多的应该是‘惊吓’才对。'},
		{MARISA,'smile','算了，说不定妖精也分不清这些。'}
	},
	[3+100]={
		{MARISA,'smile','咦？又出现了不一般的人类？'},
		{MARISA,'smile','谁？'},
		{MARISA,'smile','少见的组合，妖怪竟然和妖精联手了。'},
		{MARISA,'smile','这样一来，遭到袭击的真相就浮出了水面。'},
		{MARISA,'smile','没想到会频频失手，是时候展现我们联合起来的力量了！'},
		{MARISA,'smile','是呀是呀，我们来看看戴尖帽子的人做的梦会是什么样子吧！'},
		{MARISA,'smile','被无视了……'},
		{MARISA,'smile','不过如此听来是麻烦的组合没错了，顺手解决掉吧。'}
	},
	[4+100]={
		{MARISA,'smile','啊啊啊——'},
		{MARISA,'smile','明明就是个人类啊，难道戴尖帽子的就不一般吗！'},
		{MARISA,'smile','原来如此，一个将人吸引过来，再由另一个进行催眠。'},
		{MARISA,'smile','果然不是什么友好的家伙，在现在的异变下会制造大麻烦呢。'},
		{MARISA,'smile','没想到这么快就已经有这种没心没肺的妖怪和没心没肺的妖精在利用这场没心没肺的异变闹出没心没肺的事了，真是笨蛋和笨蛋组成的笨蛋组合。'}
	}
}
